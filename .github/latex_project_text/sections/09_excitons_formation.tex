...
In wide bandgap materials, electrons are strongly bound to their atoms, which means the relative dielectric permittivity is low for $\mathrm{SiO}_2$, where the relative dielectric constant is typically of order $2$ to $4$. As a result, the material provides weak dielectric screening of the Coulomb attraction, maintaining a deep potential well.
